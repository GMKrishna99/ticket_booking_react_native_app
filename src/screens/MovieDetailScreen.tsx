...
import { Text, View, StyleSheet, ScrollView, StatusBar, ImageBackground, Image, FlatList, TouchableOpacity } from 'react-native';
...
const MobileDetailScreen = ({ navigation, route }: any) => {
  ...
  if (movieData == undefined && movieData == null && movieCastData == undefined && movieCastData == null) {
    return (
      <ScrollView style={styles.container} bounces={false} contentContainerStyle={styles.scrollViewContainer} showsVerticalScrollIndicator={false}>
  ...
  return (
    <ScrollView style={styles.container} bounces={false} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.timeContainer}>
        ...
        <Text style={styles.runTimeText}>{Math.floor(movieData?.runtime / 60)}h {Math.floor(movieData?.runtime % 60)}min</Text>
      </View>
      <View>
        <Text style={styles.movieHeaderName}>
        ...
        <Text style={styles.movieTagline}>{movieData?.tagline}</Text>
      </View>
