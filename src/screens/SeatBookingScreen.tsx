...
const SeatBookingScreen = ({ navigation, route }: any) => {
    ...
    const selectSeat = (index: number, subindex: number, num: number) => {
        if (!twoDSeatArray[index][subindex].taken) {
            ...
            var basePrice = array.length * 150;
            var increment = (18 / 100) * basePrice;
            var finalPrice = basePrice + increment;
            setPrice(finalPrice);
    ...
    return (
        ...
        >
            <StatusBar hidden />
            <View>
                <ImageBackground style={styles.imageBackground} source={{ uri: route.params?.BgImage }}>
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            <TouchableOpacity onPress={() => setSelectedDateIndex(index)}>
                                <View style={[styles.dateContainer, index == 0
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            <TouchableOpacity onPress={() => setSelectedTimeIndex(index)}>
                                <View style={[styles.timeContainer, index == 0
                                    ? { marginLeft: SPACING.space_24 }
